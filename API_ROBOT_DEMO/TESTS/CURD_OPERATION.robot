...
*** Variables ***
@{Invalid_values}=    cha   pm  dm  tm
@{data1}=    year    price   CPU model   Hard disk size
...
#TC-01 Validate the POST call to Get Response
#    FOR    ${Value}    IN    @{Invalid_values}
#        Generating the test_json with all feilds    ${payload}    POST_DATA
#        Set To Dictionary    ${Final_payload}    name=${Value}
